...
public class GraphicWindow extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GraphicWindow
     */
    public GraphicWindow() {
        initComponents();
        
        PingTest test = new PingTest("www.google.com.br", 20);
        ArrayList<PingResult> lista = test.resultTreatment();
        
        GraphicsResults grafico = new GraphicsResults();
        this.painel.setLayout(new BorderLayout());
        
        ChartPanel createGraphicComplete = grafico.createGraphicComplete(lista);
        this.painel.add(createGraphicComplete);
         pack();
    }
